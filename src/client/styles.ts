...
.dsh_ref_checklist{display:grid;gap:14px;margin-top:20px}.dsh_ref_check{display:flex;align-items:center;gap:11px;min-height:40px}.dsh_ref_check>span{display:grid;place-items:center;width:22px;height:22px;border:1px solid var(--dsw-alias-label-primary);border-radius:50%;background:transparent;color:var(--dsw-alias-label-primary);font-size:11px;font-weight:800}.dsh_ref_check div{display:grid;gap:2px}.dsh_ref_check strong{font-size:13px}.dsh_ref_check small{color:var(--dsw-alias-label-primary);font-size:11px;opacity:.7}.dsh_ref_install{display:flex;align-items:center;justify-content:space-between;gap:18px;margin-top:20px;padding:14px;border:1px solid var(--dsw-alias-label-primary);background:transparent}.dsh_ref_install>div{display:grid;gap:3px}.dsh_ref_install strong{font-size:12px}.dsh_ref_install span{color:var(--dsw-alias-label-primary);font-size:11px;opacity:.7}.dsh_ref_error{display:grid;gap:4px;padding:13px;border:1px solid var(--dsw-alias-label-primary);background:transparent;color:var(--dsw-alias-label-primary);font-size:11px}.dsh_ref_skeleton{display:grid;gap:12px;margin-top:20px}.dsh_ref_skeleton i{height:40px;border:1px solid var(--dsw-alias-label-primary);opacity:.25}
.dsh_ref_sources{display:grid;gap:17px}.dsh_ref_provider_grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.dsh_ref_provider{display:flex;flex-direction:column;min-width:0;min-height:210px;padding:16px;border:1px solid var(--dsw-alias-label-primary);border-radius:0;background:transparent}.dsh_ref_provider_top{display:flex;align-items:center;gap:7px;color:var(--dsw-alias-label-primary);font-size:10px}.dsh_ref_provider_mark{display:grid;place-items:center;width:30px;height:30px;margin-right:auto;border:1px solid var(--dsw-alias-label-primary);color:var(--dsw-alias-label-primary)}.dsh_ref_provider_mark svg{display:block}.dsh_ref_status_dot{width:6px;height:6px;border:1px solid var(--dsw-alias-label-primary);border-radius:50%;background:transparent}.dsh_ref_status_dot.is_ready{background:var(--dsw-alias-label-primary)}.dsh_ref_provider h4{margin:17px 0 4px;font-size:14px}.dsh_ref_provider>strong{font-family:"Geist Mono",Consolas,monospace;font-size:27px}.dsh_ref_provider>p{margin:0;color:var(--dsw-alias-label-primary);font-size:11px;opacity:.7}.dsh_ref_provider>small{margin-top:9px;color:var(--dsw-alias-label-primary);font-size:10px;opacity:.7}.dsh_ref_provider>em{margin-top:6px;color:var(--dsw-alias-label-primary);font-size:10px;font-style:normal}.dsh_ref_provider_foot{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:auto;padding-top:14px}.dsh_ref_provider_foot>span{color:var(--dsw-alias-label-primary);font-size:10px;opacity:.7}.dsh_ref_provider_foot button{min-height:29px;padding:0 10px;font-size:10px}.dsh_ref_empty{padding:20px;border:1px dashed var(--dsw-alias-label-primary);color:var(--dsw-alias-label-primary);font-size:11px;text-align:center}
