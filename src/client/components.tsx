...
export function ConversationSettings({ useScope, save, sync, cancel, refresh, setupAll, install, restartDaemon, browse, deleteConversation, refreshStats, t }: SettingsProps) {
