...
export const TYPERT_MANIFEST: TypertContribution = {
  ...
  model: { services: [{
    ...
    members: [
      ...
      { kind: 'method', name: 'discoverOpenCli', signature: 'discoverOpenCli(signal: AbortSignal): Promise<OpenCliDiscovery>' },
      { kind: 'method', name: 'installOpenCli', signature: 'installOpenCli(signal: AbortSignal): Promise<OpenCliDiscovery>' },
      { kind: 'method', name: 'installAdapter', signature: 'installAdapter(signal: AbortSignal): Promise<boolean>' },
      { kind: 'method', name: 'restartDaemon', signature: 'restartDaemon(signal: AbortSignal): Promise<boolean>' },
      ...
      { kind: 'method', name: 'browse', signature: 'browse(input: BrowseInput): BrowsePage' },
